    ...
    function postRequest() {
        if(isset($_POST['action'])) {
            switch($_POST['action']) 
            {
                ...
                case 'video-ad':
                  echo $this->parseJson( $this->model->updateVideoAd() );
                  break;
                case 'game-dl':
                  echo $this->parseJson( $this->model->updateGameDownload() );
                  break;
                case 'withdraw':
                  echo $this->parseJson( $this->model->submitWithdraw() );
                  break;
            }
        }
    }
